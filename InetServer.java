    ...
    class Worker extends Thread { //Class definition, class Worker creates a thread
        ...
        public void run() {
            ...
            try {
                ...
                try {
                    String name;
                    name = in.readLine(); //read line of data from client, which gets assigned to name
                    System.out.println("Looking up " + name); //print out Looking up and the typed in name to server window
